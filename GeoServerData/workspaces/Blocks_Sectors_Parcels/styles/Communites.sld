    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:MaxScaleDenominator>184127</se:MaxScaleDenominator>
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#ff9a35</se:SvgParameter>
        ...
        <se:Rule>
          <se:MinScaleDenominator>38379</se:MinScaleDenominator>
          <se:MaxScaleDenominator>92063</se:MaxScaleDenominator>
          <se:TextSymbolizer>
            <se:Label>
