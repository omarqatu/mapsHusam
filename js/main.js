/**
 * main.js - النسخة المطورة والموحدة
 * تحافظ على التصميم وتدير الأدوات بذكاء
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // الربط الذكي للأزرار التي تحتوي على data-panel
    ...
    // زر القائمة العلوية (Responsive)
    const topToggle = document.getElementById('toggle-top-buttons-btn');
    if (topToggle) {
        topToggle.onclick = () => {
            document.getElementById('top-buttons-container').classList.toggle('hidden-buttons-container');
        };
    }

    // --- 5. تهيئة الأدوات بعد تحميل الصفحة ---
    setTimeout(() => {
