/**
 * config.js - النسخة الشاملة لجميع الحقول والطبقات
 */
...
const MAP_CONFIG = {
    ...
    // 1. حقول العقارات (شقق بيع/إيجار، أراضي)
    propertyFields: [
    ...
    // 2. حقول الخدمات (فنيين، صيانة، إلخ)
    serviceFields: [
    ...
    // 3. تعريف الطبقات (القالب)
    layers: {
        helper: [ // طبقات المساعدة
        ...
        services: [ // سيتم توليدها آلياً بناءً على قائمة serviceTranslations
