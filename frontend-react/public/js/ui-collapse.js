...
(function () {
    ...
    function initMapToolsGroup() {
        // 🆕 [إصلاح أداء حاسم]: هذا المراقب كان يشتغل حتى على صفحات لا تحتوي
        // خريطة إطلاقاً (مثل no-map-search.html)، ويراقب كامل شجرة الصفحة
        // (childList + subtree) لمدة 20 ثانية كاملة بحثاً عن ".ol-zoom" الذي
        // لن يظهر أبداً بدون خريطة OpenLayers. أي حركة DOM عادية (تحميل نتائج،
        // إعلانات، إشعارات) كانت تُشغّل هذا المراقب الثقيل من جديد وتسبب تعليقاً
        // ملحوظاً خصوصاً أثناء تغيير حجم الشاشة. التحقق المسبق من وجود #map
        // يمنع تشغيله كلياً على أي صفحة لا تحتوي خريطة.
