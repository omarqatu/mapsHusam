...
(function () {
    ...
    function buildDom() {
        ...
        // لن يجد العنصر لأنه لم يكن بعد جزءاً من شجرة المستند وقت الاستدعاء
        if (typeof window.refreshPlatformStats === 'function') {
    ...
    function renderTabBar(currentMap) {
        ...
        GROUP_ORDER.forEach(function (group) {
            ...
            if (group !== 'provider' && group !== 'smartsearch' && group !== 'locationsearch') {
                ...
                if (activePanelDef && activePanelDef.closeSel) {
